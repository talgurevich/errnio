...
export default function LandingInventoryPage() {
  ...
  const features = [
    {
      title: t.landingInventory.features.inventory.title,
      description: t.landingInventory.features.inventory.description,
      icon: (
    ...
    {
      title: t.landingInventory.features.sales.title,
      description: t.landingInventory.features.sales.description,
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: t.landingInventory.features.dashboard.title,
      description: t.landingInventory.features.dashboard.description,
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      title: t.landingInventory.features.custom.title,
      description: t.landingInventory.features.custom.description,
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="relative flex flex-col min-h-screen items-center justify-center overflow-hidden py-20">
        ...
        >
          ...
          <div className="pt-6">
            ...
            >
              <span className="relative z-10">{t.landingInventory.hero.cta}</span>
      ...
      <section className="py-20 px-6 relative">
        <div className="relative z-10 max-w-6xl mx-auto">
          ...
          >
            <span className="gradient-text neon-glow">{t.landingInventory.features.title}</span>
          </motion.h2>
      ...
      <section className="py-20 px-6 relative">
        <div className="relative z-10 max-w-4xl mx-auto text-center">
          ...
          >
            <span className="gradient-text neon-glow">{t.landingInventory.whyUs.title}</span>
          </motion.h2>
          ...
          >
            {t.landingInventory.whyUs.pills.map((pill: string, index: number) => (
              <span
                key={index}
          ...
          >
            {t.landingInventory.whyUs.description}
          </motion.p>
        </div>
      </section>
      ...
      <section className="py-20 px-6 relative">
        <div className="relative z-10 max-w-6xl mx-auto">
          <motion.h2
            ...
            className="text-4xl md:text-5xl font-bold text-center mb-14"
          >
            <span className="gradient-text neon-glow">{t.landingInventory.portfolioHighlights.title}</span>
          </motion.h2>
          ...
          >
            ...
            >
              {t.landingInventory.portfolioHighlights.viewAll}
