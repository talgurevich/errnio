...
const GOOGLE_REVIEWS_URL = 'https://www.google.com/maps/place/errnio/@32.9566414,35.0810915,19z/data=!4m8!3m7!1s0x151dc93cf75b68b3:0x9d9e05b4b2c8f42!8m2!3d32.95602!4d35.081697!9m1!1b1!16s%2Fg%2F11n3xyn1b_?entry=ttu&g_ep=EgoyMDI2MDMwNC4xIKXMDSoASAFQAw%3D%3D';
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <div className="flex items-center justify-center gap-2">
              ...
              <a href={GOOGLE_REVIEWS_URL} target="_blank" rel="noopener noreferrer" className="text-gray-500 text-sm hover:text-blue-600 transition-colors">ב-Google</a>
            </div>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
            {[
              ...
              <div key={i} className="bg-gray-50 rounded-2xl p-6 md:p-8 border border-gray-100">
                ...
                <a href={GOOGLE_REVIEWS_URL} target="_blank" rel="noopener noreferrer" className="mt-3 flex items-center gap-1.5 hover:opacity-80 transition-opacity">
